              ...
              <div className="postTitleAndImage">
                ...
                <div className="wrapSubContent">
                  ...
                  <span className="articleContent">
                    ...
                    부패뿐이다. 보내는 생명을 일월과 긴지라 같은 속잎나고, 밥을
                    인생에 교향악이다. 이것이야말로 피에 싸인 때문이다. 보는
                    용감하고 얼마나 가장 같으며, 것이다. 낙원을 무한한 인류의
                    따뜻한 꽃이 수 그들은 약동하다. 피어나기 그들은 그들은 수
                    과실이 능히 커다란 든 거친 아름다우냐? 싸인 들어 동력은
                    사막이다. 산야에 청춘에서만 대고, 사랑의 내려온 있는
                    약동하다. 내는 용기가 주며, 방황하여도, 것은 그림자는
                    끓는다.
                  </span>
                </div>
            ...
            <div className="wrapWriter">
              ...
              <div className="detailRecommend">
                ...
                <span className="textInfo">
                  <span className="writeNum">글 135</span>
                  <span className="writeNum">구독자 671</span>
                </span>
              </div>
            </div>
          </div>

      ...
      <section className="articlesContainer">
        <div className="articlesbox">
          ...
          <span className="articlesUserFeedSub">
            ...
            사서 HBO로 요즘 핫하다는 듄을 봤다. 아주 먼 미래의 이야기라 주인공이
            걸어 다니면 조명이 따라다닌다. 티모시가 나오는데도 불구하고 나는
            중간에 박차고 나왔다. 아이맥스로 봐야 재밌다는 걸 집에서 봐서 그런
            걸까?
          </span>
          <span className="articlesUserFeedName">by 작성자</span>
        </div>
        <div className="articlesbox">
          <img
            className="articlesUserFeedImg"
        ...
        <SlideButton className="articlesButton" />
      </section>
    </div>
  );
}
